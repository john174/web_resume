...
The repository also includes `streamlit_app.py` which renders the resume using [Streamlit](https://streamlit.io/). It recreates the page with Streamlit's core components instead of embedding the static HTML.
